...
# # set text annotations for model names insted of tick labels
...
# # plot distribution of question + context lengths
# lengths = [calculate_length(example) for example in val_dataset]
# plt.figure(figsize=(14, 6))
# plt.hist(lengths, bins=50, color='skyblue', edgecolor='black')
# plt.xlabel('Question + Context Length')
# plt.ylabel('Count')
# plt.title('Distribution of Question + Context Lengths')
# plt.show()

# # Define bins for lengths
# # every 10 until 200 and 200+
...
#     length = calculate_length(example)
...
#         bin_indices = [index for index, bin_num in enumerate(binned_lengths) if bin_num == i]
...
# ax.set_xlabel('Question + Context Length Bins')
# ax.set_ylabel('Accuracy')
# ax.set_title('Accuracy vs Question + Context Length Bins')
# ax.legend()
...
# # print finetuned and gp4o predictions for examples wher length is less than 50
# for example, length in zip(val_dataset, lengths):
#     if length < 100:
#         print(100*"-")
...
# costs = [baseline_cost, fine_tuned_cost, gpt35_cost, gpt4o_cost]
